...
<?php include(HEADER_TEMPLATE); ?>
 <body>
	...
	<nav aria-label="...">
	  <ul class="pagination">
		<li class="page-item active"><a class="page-link" href="#">Revista</a></li>
		<li class="page-item"> <span class="page-link">Paper </span></li>
		<li class="page-item"><a class="page-link" href="#">Livro</a></li>
	  </ul>
	</nav>
