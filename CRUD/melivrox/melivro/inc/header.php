      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav mr-auto">
          ...
          Pedidos
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdown02">
				<li><a class="dropdown-item" href="<?php echo BASEURL; ?>pedidos/listapedidos.php">Lista Pedidos</a></li>
			</ul>
          </li>
          <li class="nav-item dropdown">
			<a class="nav-link dropdown-toggle" href="example.com" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Vendas
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdown02">
				<li><a class="dropdown-item" href="<?php echo BASEURL; ?>vendas/listarvendas.php">Lista Vendas</a></li>
			</ul>
          </li>
        </ul>
