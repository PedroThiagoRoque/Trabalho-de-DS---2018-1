CREATE DATABASE IF NOT EXISTS MeLivro;
...
CREATE TABLE IF NOT EXISTS PRODUTO(
   ...
   PRECO  DOUBLE(2, 3) NOT NULL, -- Trocar tipo
...
CREATE TABLE IF NOT EXISTS VENDA(
   ...
   VALORVENDA DOUBLE(3,2) NOT NULL,
